...
>[!NOTE]
>
>Cette page décrit comment créer et gérer des tickets d’assistance pour les solutions Adobe Customer Experience Orchestration (CXO). Pour afficher les informations de prise en charge des solutions Adobe Creative Cloud, [cliquez ici](https://helpx.adobe.com/support.html).
