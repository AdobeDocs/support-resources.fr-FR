---
title: Assistant vocal d’assistance Adobe - Assistance après les heures de bureau et le week-end (Japon)
description: L’assistant vocal d’assistance Adobe aide les clients japonais à bénéficier d’une assistance téléphonique en japonais pendant les heures creuses et le week-end pour les mises à jour des cas, les remontées urgentes et les demandes de rappel.
hold: true
...
# Assistant vocal d’assistance Adobe - Assistance après les heures de bureau et le week-end (Japon)
...
>[!TIP]
>
>Si votre problème entraîne une panne importante ou a de graves répercussions sur l&#39;entreprise, l&#39;assistant peut immédiatement augmenter la priorité de votre dossier (voir « Augmenter la priorité du dossier à P1 » ci-dessous).

## Ce que peut faire l’assistant vocal

L’assistant vocal AI prend en charge les fonctionnalités suivantes :
...
* Remontez la priorité des cas à P1, le cas échéant.
...
L’assistant peut partager les notes les plus récentes ou la progression de votre dossier. Vous pouvez ainsi savoir exactement ce qui s’est passé jusqu’à présent sans avoir à attendre un rappel ou un e-mail.
...
Bien que l’assistant vocal d’IA puisse gérer de nombreux besoins d’assistance courants, il existe certaines choses qu’il ne peut pas faire actuellement. Dans ce cas, l’assistant vous guidera vers un ingénieur du support humain.

* **Impossible d&#39;accéder aux dossiers en dehors de votre compte vérifié** — vous devrez vérifier votre identité ou les détails du dossier avant que l&#39;assistant puisse partager des informations sur le dossier
...
* **Impossible d’effectuer des modifications de configuration du produit** par exemple, modifier les paramètres de votre produit ou environnement Adobe

* **Impossible de faciliter le transfert d’appel à un agent humain**
