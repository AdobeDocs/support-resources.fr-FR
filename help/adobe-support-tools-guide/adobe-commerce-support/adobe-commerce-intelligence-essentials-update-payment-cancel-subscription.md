...
>[!IMPORTANT]
>
>Si vous accédez à Commerce Intelligence par le biais d’un contrat Adobe Commerce, les mises à jour et annulations de facturation ne sont pas gérées en libre-service dans account.magento.com.

## Produits et versions concernés

* Commerce Intelligence Essentials : pertinent uniquement pour les clients Essentials mois par mois. Pas pour les clients qui ont accès à Essentials dans le cadre de leur contrat de commerce.
...
3. Sélectionnez **[!UICONTROL Mettre à jour le mode de paiement]** ou **[!UICONTROL Annuler la licence]**.
