...
S’ils ont été ajoutés à la [!DNL cloud project], mais ne disposent pas du [!DNL Project Admin role], mettez à jour leur [!DNL role] en conséquence dans [Gérer l’accès utilisateur](https://experienceleague.adobe.com/docs/commerce-cloud-service/user-guide/project/user-access.html).
