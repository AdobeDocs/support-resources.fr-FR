...
>[!NOTE]
>
>La prise en charge d’Adobe Commerce a migré du Centre d’aide Adobe Commerce vers Experience League. Utilisez le flux de formulaire de cas Experience League décrit [ici](#what-is-experience-support) pour envoyer des cas d’assistance.
...
>[!NOTE]
>
>La partie Base de connaissances du Centre d’aide Adobe Commerce a migré vers le portail Adobe Experience League. Lorsque vous créez un ticket d’assistance, des articles de la base de connaissances vous sont suggérés, ainsi que d’autres documents Adobe Commerce pertinents d’Adobe Experience League.

**Mise À Jour Majeure :** Le 29 Juillet 2024

**[EN QUOI CONSISTE LA PRISE EN CHARGE D’EXPERIENCE LEAGUE ?](#what-is-experience-support)**

**[DOSSIERS D’ASSISTANCE](#support-cases)**
...
* [Clore l&#39;affaire](#close-case)
* [Rouvrir votre dossier](#reopen-case)
...
**[ACCÈS PARTAGÉ : ACCORDEZ DES PRIVILÈGES AUX AUTRES UTILISATEURS POUR ACCÉDER À VOTRE COMPTE](#shared-access)**

* [Qui peut fournir l’accès partagé](#who-can-provide-shared-access)
...
## CAS D’ASSISTANCE {#support-cases}
...
1. Accédez à [experienceleague.adobe.com](https://experienceleague.adobe.com/fr?lang=fr).
1. Connectez-vous à l’aide de vos identifiants de connexion Adobe.

![connexion-experience-league](/help/adobe-support-tools-guide/assets/experience_league_sign_in.png)
...
>[!NOTE]
>
>Les demandes d’assistance pour l’équipe Adobe Commerce Marketplace ne peuvent pas être envoyées via Experience League, car leur système d’assistance fonctionne sur une plateforme distincte qui n’est pas intégrée à Experience League.
>
>Vous pouvez soumettre votre dossier d’assistance si les affirmations suivantes sont vraies :
>
...
Pour soumettre un nouveau cas d’assistance à l’aide de la page de démarrage d’Adobe Experience League, reportez-vous à la section [Création d’un ticket d’assistance avec Experience League](https://experienceleague.adobe.com/fr/docs/support-resources/adobe-support-tools-guide/adobe-customer-support-experience#create-a-support-ticket-with-experience-league).

>[!INFO]
>
>1. Pour soumettre un cas, vous devez avoir droit à l’assistance pour le produit approprié (par exemple, Adobe Commerce, Adobe Commerce Intelligence, Adobe Commerce Payment Services, Experience Platform, etc.). Si vous n’avez pas droit à l’assistance, une barre s’affiche en haut de la page pour vous informer que vous n’avez pas droit à l’assistance dans l’entreprise.
>1. Si vous appartenez à plusieurs organisations ou s’il existe plusieurs organisations dont les noms sont similaires (chacune représente l’un des autres produits Adobe auxquels elle est abonnée), vous devez d’abord sélectionner l’organisation appropriée dans la liste déroulante de la colonne de gauche qui se termine par *[!DNL (Commerce)]*.
>1. Si la liste déroulante **[!UICONTROL Sélectionner un produit]** est vide lors de l’envoi d’un dossier, il est probable que vous utilisiez un compte de partenaire Adobe Commerce. Seuls les utilisateurs disposant d’un [accès partagé](#shared-access) d’un commerçant avec des droits d’assistance peuvent envoyer des tickets. Pour les problèmes des commerçants, demandez un accès partagé. Pour toute question concernant les partenaires, contactez spphelp@adobe.com.

>[!NOTE]
>
>Assurez-vous d&#39;avoir sélectionné la bonne organisation avant de soumettre le dossier et que l&#39;organisation que vous avez sélectionnée dispose des droits appropriés pour le produit pour lequel vous demandez une assistance. Par exemple, si votre problème est lié à Adobe Commerce, mais que vous avez sélectionné Adobe Commerce Intelligence ou Adobe Experience Platform comme produit et que le dossier a été soumis avec succès, cela peut entraîner un mauvais routage de votre dossier et des retards dans les temps de réponse.
>
>De plus, si la mauvaise organisation a été sélectionnée au moment où le cas a été soumis, votre équipe ne sera pas en mesure d&#39;afficher le cas sous **[!UICONTROL Mes cas]** pour l&#39;organisation appropriée. L’équipe d’assistance Adobe Commerce n’a pas la possibilité de modifier l’organisation associée au dossier. Pour résoudre ce problème, vous devez clôturer le dossier existant et soumettre un nouveau dossier avec les détails appropriés fournis/sélectionnés.
...
>[!IMPORTANT]
>
>Si votre organisation ne s’affiche pas dans le menu déroulant lorsque vous vous connectez à experienceleague.adobe.com, vous devrez peut-être synchroniser votre profil avec accounts.magento.com avant de demander une assistance ou de gérer un dossier d’assistance existant.
>
...
>[!NOTE]
>
>Importance de l’organisation/du produit
>
>**Exemple A** : vous n’avez partagé l’accès qu’à une seule société et cette société dispose de droits sur deux produits Adobe : Product1 et Product2.
>
>1. Comme chaque organisation représente un produit, deux organisations s’affichent dans la liste déroulante, par exemple OrgA-Product1 et OrgB-Product2.
>1. Si vous avez sélectionné Produit = Produit1 mais que votre problème est lié à Produit2, le dossier sera acheminé vers le support Produit2 et le transfert du dossier au support Produit1 sera retardé.
>1. Si vous avez soumis le cas pour OrgA-Product1 et que vous souhaitez examiner **[!UICONTROL Mes cas]** pour cette organisation à l’avenir, vous ne le verrez pas si vous sélectionnez OrgA-Product2 comme organisation (il vous suffirait de sélectionner l’autre organisation, par rapport à l’exemple B).
>
>**Exemple B** : vous avez un accès partagé à deux sociétés, et chaque société ne dispose que de droits pour Adobe Commerce.
>
>1. Si vous avez soumis le dossier pour OrgA, mais que le problème a en fait un impact sur OrgB, les membres d’OrgB ne pourront plus voir ce dossier sous **[!UICONTROL Mes dossiers]** à l’avenir.
>1. En outre, les membres d’OrgA pourront consulter les cas sous **[!UICONTROL Mes cas]** qui sont en fait destinés à OrgB, ce qui peut entraîner des problèmes de confidentialité.
...
>
>* Vos droits Commerce ont expiré ou sont inactifs (par exemple, en raison d’un problème de facturation ou de licence en suspens).
>* Pour les instances hébergées sur Adobe Commerce sur des infrastructures cloud (PaaS), vous n’avez pas été ajouté au projet cloud.
>
>Pour Adobe Commerce sur les projets cloud, contactez le propriétaire de votre compte et demandez à être ajouté au projet cloud approprié. Pour plus d’informations, voir [Gérer l’accès des utilisateurs](https://experienceleague.adobe.com/fr/docs/commerce-on-cloud/user-guide/project/user-access) pour Adobe Commerce sur les infrastructures cloud.
>
...
Si vous disposez déjà d’un compte sur https://account.magento.com mais que vous ne parvenez pas à vous connecter, il se peut que vous ne vous soyez pas enregistré sur https://account.adobe.com, obligatoire à compter d’août 2022.

Pour résoudre ce problème, procédez comme suit :

1. Créez un compte à l’adresse https://account.adobe.com en utilisant la même adresse e-mail sur votre ID MAG.
1. Accédez à https://account.magento.com pour lier votre Adobe ID à l’ID MAG.
...
1. Sélectionnez **[!UICONTROL Ouvrir le ticket]** dans le menu de gauche.
1. Renseignez les [champs](https://experienceleague.adobe.com/fr/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-support-ticket-contact-reason-descriptions).
...
### Suivi de vos cas d’assistance Commerce {#track-support-case}
...
>[!NOTE]
>
>Si des cas d’assistance vous ont été soumis pour d’autres produits Adobe en plus de Commerce, le suivi de ces tickets ne peut pas être effectué à partir du même écran. Vous devez d’abord passer à l’organisation associée aux droits du produit.
>Par exemple, vous avez précédemment sélectionné l’organisation se terminant par « (Commerce) » pour effectuer le suivi de votre cas Commerce, tandis que vous disposez également de cas d’assistance AEP ; ces cas ne seront pas affichés ici.
...
Vous pouvez afficher les dossiers Commerce auxquels vous avez été *ajouté en tant qu’observateur* en cliquant sur **[!UICONTROL Dossiers de mon organisation]** dans le menu de gauche.
...
Pour rechercher des cas, saisissez votre requête de recherche dans le champ *[!UICONTROL Rechercher]* et appuyez sur *Entrée* sur le clavier.

![cas-recherche](/help/adobe-support-tools-guide/assets/search_cases.png)
...
1. Cliquez sur **[!UICONTROL Escalader vers la direction]** en bas à droite du panneau *[!UICONTROL Détails du dossier]* sur le côté droit de l’écran.

   ![escalate-to-management](/help/adobe-support-tools-guide/assets/escalate_to_management.png)

1. Après avoir cliqué, un formulaire pop-up s’affiche. Remplissez le formulaire, puis cliquez sur **[!UICONTROL Escalader]**.

   ![confirmer-réaffectation](/help/adobe-support-tools-guide/assets/confirm_escalation.png)
...
1. Pour ajouter un observateur à un cas existant, ouvrez le cas et cliquez sur l’icône en forme de crayon en regard de « observateurs » dans le panneau Détails du cas sur le côté droit de l’écran.
...
1. Écrivez votre commentaire dans le champ **[!UICONTROL Commentaires]** et cliquez sur **[!UICONTROL Ajouter des commentaires]**.

![add-comments](/help/adobe-support-tools-guide/assets/add_comments.png)

### Clore l&#39;affaire {#close-case}

Pour fermer la casse, cliquez sur **[!UICONTROL Fermer la casse]** en bas à droite du panneau *[!UICONTROL Détail de la casse]*.

![close-case](/help/adobe-support-tools-guide/assets/close_case.png)

>[!NOTE]
>
>Pour plus d’informations sur la façon de clôturer votre litige, reportez-vous à la vidéo [Ajouter et supprimer des observateurs, fermer et rouvrir des tickets](https://experienceleague.adobe.com/fr/docs/commerce-learn/tutorials/help-and-support/add-remove-watchers-close-reopen-support-ticket).

### Rouvrir votre dossier {#reopen-case}

>[!NOTE]
>
>**Vous ne pouvez rouvrir un dossier que dans les 14 jours suivant sa clôture.** Si vous avez dépassé 14 jours après la clôture du dossier, mais que vous souhaitez toujours demander de l’aide sur un problème, vous devez ouvrir un nouveau dossier.<br>Pour plus d’informations sur la fermeture et la réouverture des dossiers, voir la vidéo [Ajouter et supprimer des observateurs, fermer et rouvrir des tickets](https://experienceleague.adobe.com/fr/docs/commerce-learn/tutorials/help-and-support/add-remove-watchers-close-reopen-support-ticket).
...
1. Sélectionnez **[!UICONTROL Assistance]** dans le menu utilisateur.
1. La page **[!UICONTROL Mes tickets]** se charge.
1. Cliquez sur **[!UICONTROL Soumettre un ticket]** dans le coin supérieur droit.
1. Renseignez les [champs](https://experienceleague.adobe.com/fr/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-support-ticket-contact-reason-descriptions).
...
Vous pouvez fournir et gérer l’accès partagé à l’aide de la page de votre compte Adobe Commerce sur [https://account.magento.com](https://account.magento.com/).
...
1. Connectez-vous à votre compte Adobe Commerce sur [https://account.magento.com](https://account.magento.com/).
1. Dans le panneau de gauche, sous Accès partagé, choisissez **Gérer les autorisations.**
1. Recherchez l’utilisateur à partir duquel révoquer l’accès partagé et cliquez sur ![icône de suppression](/help/adobe-support-tools-guide/assets/remove_icon.png){width="25"} dans la ligne de l’utilisateur (**colonne Actions**).
1. Cliquez sur **Supprimer utilisateur** pour révoquer l’accès ou sur X dans le coin supérieur pour annuler la révocation.

   ![révoke_shared_access](/help/adobe-support-tools-guide/assets/revoke_shared_access.png){width="800"}

   Vous pouvez également révoquer l’accès partagé à l’aide du menu **Modifier** :

1. Connectez-vous à votre compte Adobe Commerce sur [https://account.magento.com](https://account.magento.com/).
1. Dans le panneau de gauche, sous Accès partagé, choisissez **Gérer les autorisations.**
1. Recherchez l’utilisateur à partir duquel révoquer l’accès partagé et cliquez sur **Modifier** dans la ligne de l’utilisateur (**colonne Actions**).
1. Cliquez sur **Supprimer cet utilisateur** au bas de la page.
1. Dans la fenêtre contextuelle de confirmation, cliquez sur **Supprimer un utilisateur** pour révoquer l’accès ou sur X dans le coin supérieur pour annuler la révocation.
...
Si vous avez ou avez eu un projet Adobe Commerce Cloud et que vous avez ajouté un utilisateur au projet, il se peut que l’accès partagé lui ait été automatiquement accordé sur l’ID d’image du propriétaire du projet. Cela est normalement indiqué dans la colonne **[!UICONTROL Nom du partage]**, qui affiche *Accès partagé dans le cloud depuis MAG[XYZ]*.

>[!NOTE]
>
>Si le lien DELETE est manquant, cela signifie que l’accès partagé a été automatiquement accordé via Commerce Cloud.

<u>Solution</u>

Il n&#39;est pas possible de supprimer la liste des utilisateurs d&#39;accès partagé avec le nom de partage *Cloud Shared Access from MAG[XYZ]* si l&#39;accès partagé n&#39;a pas été ajouté/donné [sur cette page](https://account.magento.com/grantor/manage/). Elles sont conservées à des fins d’information/d’audit.
...
1. Connectez-vous à votre compte Adobe Commerce sur [https://account.magento.com](https://account.magento.com/).
1. Dans le panneau de gauche, sous **[!UICONTROL Accès partagé]**, sélectionnez **[!UICONTROL Gérer les autorisations]**.
1. Recherchez l’utilisateur à partir duquel révoquer l’accès partagé et cliquez sur **[!UICONTROL Modifier]** dans la ligne de l’utilisateur (*[!UICONTROL colonne Actions]*).
1. Décochez toutes les ressources sous **[!UICONTROL Accorder les autorisations de compte]**.
1. Pour éviter toute confusion sur le fait de savoir si l’utilisateur dispose toujours de l’autorisation **[!UICONTROL Accès partagé dans le cloud]**, vous devez modifier l’autorisation **[!UICONTROL Nom du partage]** pour lui donner un nom du type *Accès partagé dans le cloud révoqué - ne peut pas être supprimé* ou un nom similaire.
...
### Accès à votre compte partagé (changer de compte) {#switch-accounts}

>[!NOTE]
>
>Cette étape n’est pas nécessaire pour envoyer des tickets pour Adobe Commerce.
>Pour une démonstration sur l’envoi d’un ticket Adobe Commerce, [regardez cette vidéo](https://experienceleague.adobe.com/fr/playlists/support-requests).
...
Reportez-vous à l’article [Dépannage de l’accès partagé](https://experienceleague.adobe.com/fr/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/shared-access-troubleshooting) dans notre base de connaissances du support.
