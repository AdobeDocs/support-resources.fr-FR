...
Pour commencer, connectez-vous à [Global Admin Console](https://global-admin-console.adobe.com/). Accédez ensuite à l’onglet **[!UICONTROL Insights]** et sélectionnez **[!UICONTROL Journaux d’audit]** pour suivre toutes les modifications apportées à l’échelle des organisations.
...
1. En tant qu&#39;administrateur global, connectez-vous à [Global Admin Console](https://global-admin-console.adobe.com/insights).
...
Les journaux d’audit affichent les informations suivantes pour les événements filtrés :
   ...
   | Nom de l’objet | Le nom du produit, du profil de produit ou du groupe d’utilisateurs impliqué dans l’événement, selon le cas. |
   ...
   | Adresse IP | Adresse IP de la machine sur laquelle l’action a été effectuée. Reflète généralement l’emplacement physique, mais il peut s’agir d’un serveur proxy ou d’une adresse VPN. |
...
1. Vous pouvez filtrer les journaux d’audit à l’aide des options suivantes :
   ...
   - Vous pouvez combiner des filtres pour limiter les résultats, par exemple en affichant les événements des sept derniers jours pour une organisation spécifique.
...
Lorsqu&#39;un administrateur global exporte des données d&#39;organisation à partir de [Global Admin Console](https://global-admin-console.adobe.com/insights), le rapport est traité et rendu disponible sous l&#39;onglet **[!UICONTROL Insights]** dans **[!UICONTROL Exporter des rapports]**.
...
1. Connectez-vous à [Global Admin Console](https://global-admin-console.adobe.com/insights) et accédez à **[!UICONTROL Insights]** > **[!UICONTROL Exporter des rapports]**.
