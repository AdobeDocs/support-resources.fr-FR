...
- Pour vous assurer que toutes les modifications apportées à la [[!DNL Global Admin Console]](https://helpx.adobe.com/fr/enterprise/global-admin-console/adopt-global-administration.html) sont implémentées et prennent effet, sélectionnez l’onglet [[!UICONTROL Exécution de la tâche]] et poursuivez l’exécution des modifications en attente.

  Se connecter à l’[[!DNL Global Admin Console]](https://global-admin-console.adobe.com/)
...
En tant qu’administrateur global, vous pouvez vérifier et exécuter les modifications en attente à partir de l’onglet [[!UICONTROL Exécution de tâche]].

### Étapes d’exécution des modifications

1. Connectez-vous à [[!DNL Global Admin Console]].
...
4. Sélectionnez [[!UICONTROL Soumettre les modifications]] pour les exécuter.
...
- Le traitement est marqué comme [[!UICONTROL Failed]].
