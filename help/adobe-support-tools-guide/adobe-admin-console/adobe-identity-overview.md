...
>[!NOTE]
>Si votre organisation n’a pas été mise à jour vers le modèle de stockage d’entreprise Adobe et que vous utilisez toujours des Adobe ID pour les individus, consultez la description dans le tableau [types d’identité](https://helpx.adobe.com/fr/enterprise/using/identity.html#using-personal-adobe-id) ci-dessous.
...
<td><a href="https://helpx.adobe.com/fr/enterprise/using/add-domains-directories.html#claim-domains">Demander des domaines</a></td>
<td><a href="https://helpx.adobe.com/fr/enterprise/using/users.html#add-users">Ajouter un utilisateur ou une utilisatrice</a></td>
</tr>
</tbody>
</table>
...
>
>1. La politique de mot de passe pour Creative Cloud pour les équipes est identique à celle de Creative Cloud pour les individus.
>1. Pour les clients Creative Cloud abonnement Entreprise qui utilisent [stockage d’entreprise](https://helpx.adobe.com/fr/enterprise/using/manage-adobe-storage.html), les administrateurs peuvent ajouter des utilisateurs Adobe ID à Admin Console, mais ne peuvent pas les ajouter aux profils de produits. Les administrateurs doivent migrer les utilisateurs d’Adobe ID vers un autre type d’identité.
...
- [Changer d’identité utilisateur](https://helpx.adobe.com/fr/enterprise/using/switch-user-identity.html)
...
- [FAQ sur l’éducation](https://helpx.adobe.com/fr/x-productkb/policy-pricing/education-faq.html)
