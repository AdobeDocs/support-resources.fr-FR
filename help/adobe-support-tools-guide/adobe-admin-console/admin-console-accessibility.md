...
Découvrez la prise en charge de l’accessibilité dans Adobe Admin Console, qui fournit un emplacement central pour gérer vos droits Adobe dans l’ensemble de l’organisation.

## Prise en charge de l’accessibilité du système d’exploitation

Les fonctionnalités d’accessibilité de nombreux systèmes d’exploitation couramment utilisés peuvent être utilisées dans Admin Console. Ces fonctionnalités d’accessibilité incluent un contraste élevé et d’autres paramètres d’affichage. Cependant, il peut y avoir certaines limitations dues à l’interface utilisateur actuelle d’Admin Console.
...
Admin Console offre une prise en charge des technologies d’assistance (qui incluent les lecteurs d’écran et les agrandisseurs d’écran). Pour plus d’informations, voir [Rapport de conformité de l’accessibilité](https://www.adobe.com/accessibility/compliance.html).
