...
# Assistance Elite pour Creative Cloud et Adobe Document Cloud

![icône](assets/Elitebanner.png)

Adobe fournit une gamme complète de ressources techniques pour vous aider à soutenir votre entreprise, y compris dans le cadre de votre abonnement Adobe Entreprise, que vient compléter le service d’assistance ELITE. Les clients ELITE ont accès à un ingénieur d’assistance nommé ainsi qu’à un gestionnaire de compte technique qui collaborent avec vous pour fournir la meilleure assistance proactive et réactive de sa catégorie tout en jouant le rôle de contacts techniques désignés au sein de l’équipe d’assistance Adobe.

Forte d’une expérience approfondie de vos solutions Creative Cloud et Document Cloud applicables, votre équipe d’assistance met tout en œuvre pour être présente à vos côtés tout au long de l’opération, quelle que soit la complexité de vos besoins d’assistance, afin que vous optimisiez votre investissement dans les solutions d’Adobe applicables et pour vous aider à éviter les problèmes avant qu’ils ne se produisent. Vous pouvez également utiliser notre documentation technique détaillée et approfondie sur les produits et nos notes de mise à jour actuelles.

[Afficher la version PDF](assets/DMeEliteSupportDatasheet_2022.pdf)
...
<tr>
  <td>
    ...
    <p>Gestionnaire de compte technique désigné pour superviser et recommander votre expérience d’assistance Elite et fournir des services proactifs afin d’optimiser la valeur de votre entreprise.</p>
    </div>
  </td>
  <td>
...
<tr>
  <td>
    ...
    <div>
    <p><b>Surveillance proactive des cas et gestion des remontées d’informations</b></p>
    <p>Il s’agit d’un point de contact désigné au sein d’Adobe qui surveillera activement les cas ouverts et qui peut fournir une assistance en matière de remontées d’informations, des mises à jour régulières tout en s’assurant que la priorité est mise sur vos demandes d’assistance ouvertes les plus importantes.</p>
    </div>
  </td>
  <td>
...
<tr>
  ...
  <td>
    ...
    <div>
    <p><b>Examen de la feuille de route et de la solution</b></p>
    <p>Il s’agit d’un examen proactif du déploiement, de la configuration et de l’architecture globale de votre solution, notamment les intégrations. Alignez votre solution et la feuille de route du projet pour réduire les risques et vous préparer à l’avenir.</p>
    </div>
  </td>
  <td>
...
<tr>
  <td>
    ...
    <p>Recevez des conseils personnalisés et bénéficiez d’un examen proactif à des fins de planification des mises à niveau et de la migration. Profitez du plan de mise à jour et de mise à niveau des examens par les experts Adobe.</p>
    </div>
  </td>
  <td>
    <img alt="Partenaire exécutif" src="assets/dmeexecutivesponsor.png"/>
    <div>
    <p><b>Partenaire exécutif</b></p>
    <p>Bénéficiez du soutien d’un partenaire exécutif de l’équipe de direction Adobe chargée de l’assistance.</p>
    </div>
  </td>
  <td>
    <img alt="Autres contacts d’assistance nommés" src="assets/dmeadditionalnamedsupportcontacts.png"/>
    <div>
    <p><b>Autres contacts d’assistance nommés</b></p>
    <p>D’autres contacts d’assistance nommés ont l’avantage de pouvoir utiliser les canaux disponibles pour interagir avec notre équipe d’assistance technique au nom de votre entreprise.</p>
    </div>
  </td>
</tr>
</table>
