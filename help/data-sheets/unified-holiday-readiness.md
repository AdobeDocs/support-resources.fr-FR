...
* Utilisez votre framework d’expérimentation pour tester les modifications des variables clés :
  ...
  * type d’offre
  * mélange de canaux
    Reportez-vous aux [bonnes pratiques ](https://experienceleague.adobe.com/en/docs/experimentation-accelerator/using/get-started/experiment-accelerator-best-practices).
...
* Surveiller et appliquer le capping des appels/des connexions API : par exemple, consultez l’article [API de limitation | Adobe Journey Optimizer](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/connect-systems/external-systems/capping).
...
* Pour obtenir des informations détaillées et des conseils sur la préparation à un trafic élevé avec les services cloud Adobe Experience Manager, reportez-vous aux liens suivants :
  ...
  * [Mise en cache d’AEM as a Cloud Service](https://experienceleague.adobe.com/en/docs/experience-manager-learn/cloud-service/caching/overview)
...
* [Présentation De La Version Du 1Er Trimestre 2025](https://experienceleague.adobe.com/en/docs/workfront/using/product-announcements/product-releases/release-25-q1/25-q1-release-overview)
...
* [Optimiser les performances d’Analysis Workspace](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/workspace-faq/optimizing-performance)
...
* [Guide des composants d’Analytics : file d’attente des rapports planifiés](https://experienceleague.adobe.com/en/docs/analytics/components/scheduled-reports-admin)
