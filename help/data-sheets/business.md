...
Les services d’assistance aux entreprises de Adobe Experience Cloud offrent un accès complet aux équipes d’assistance technique d’Adobe et à un responsable d’assistance pour la gestion de compte.
...
<tbody>
  <tr>
    ...
    <td></td>
    <td></td>
    <td>Prise en charge des Adobes ($)</td>
  </tr>
  <tr>
...
|--- |--- |--- |
| <b>PRIORITÉ 1</b><br>Les fonctions commerciales de production du client sont en panne ou présentent une perte de données ou une dégradation importante du service. Une attention immédiate est nécessaire pour restaurer les fonctionnalités et la convivialité. | 24x7/<br>1 heure | 24x7/<br>1 heure |
| <b>PRIORITÉ 2</b><br> Les fonctions commerciales du client ont une dégradation majeure du service ou une perte potentielle de données, ou une fonctionnalité majeure est affectée. | Heures d’ouverture/<br>4 heures | Heures d’ouverture/<br>2 heures |
| <b>PRIORITÉ 3</b><br> Les fonctions commerciales du client ont une dégradation mineure du service, mais il existe une solution/solution permettant aux fonctions commerciales de continuer. | Heures d’ouverture/<br>6 heures | Heures d’ouverture/<br> 4 heures |
...
<tr>
  <td>
    <img alt="Responsable du support compte" src="assets/Accountsupportlead.png"/>
    <div>
    <p><b>Responsable du support compte</b></p>
    <p>Un service d’assistance désigné : dirigez-vous pour surveiller de manière proactive les cas, favoriser la collaboration entre équipes, diffuser des webinaires d’intégration, exécuter des rapports de service, fournir une assistance non technique et agir comme point de réaffectation et comme défenseur interne au sein du service d’assistance Adobe.</p>
    </div>
  </td>
  <td>
    <img alt="Prise en charge téléphonique" src="assets/livetelephonesupport.png"/>
    <div>
    <p><b>Assistance téléphonique en direct</b></p>
    <p>Les clients peuvent soumettre des cas d’assistance par l’intermédiaire de Phone pour tous les problèmes P2, P3 et P4 pendant les heures d’assistance régionales. Il n’existe pas de limite supérieure au nombre de fois où vous pouvez appeler pour la prise en charge. Les clients peuvent également demander un rappel auprès de l’assistance ou demander une réunion pour démontrer ou résoudre un problème à l’aide d’une session de bureau à distance partagée.</p>
    </div>
  </td>
  <td>
    <img alt="Gestion des extensions" src="assets/EscalationManagement.png"/>
    <div>
...
<tr>
  <td>
    ...
    <p>Un chargé de compte hébergera des webinaires présentant un aperçu des services d’assistance aux entreprises.</p>
    </div>
  </td>
  <td>
  </td>
...
<tr>
  <td>
    ...
    <p>Accès en ligne permanent à une base de données croissante de solutions techniques, de documentation sur les produits, de questions fréquentes, etc. Des milliers de clients peuvent se connecter pour partager les bonnes pratiques et les leçons apprises.</p>
    </div>
  </td>
  <td>
